...
type Company struct {
	// Details
	CompanyName   string `bson:"companyname,omitempty" sql:"varchar 160"`
	CompanyNumber string `bson:"companynumber,omitempty" sql:"varchar 8"`
	Careof        string `bson:"careof,omitempty" sql:"varchar 100"`
	POBox         string `bson:"pobox,omitempty" sql:"varchar 10"`
	AddressLine1  string `bson:"addressline1,omitempty" sql:"varchar 300"`
	AddressLine2  string `bson:"addressline2,omitempty" sql:"varchar 300"`
	...
	PostCode      string `bson:"postcode,omitempty" sql:"varchar 20"`
	// Corporate
	...
	// Accounts
	AccountingRefDay       string `bson:"accountingrefday,omitempty" sql:"smallint"`
	AccountingRefMonth     string `bson:"accountingrefmonth,omitempty" sql:"smallint"`
	...
	// Web
	URI string `bson:"uri,omitempty" sql:"varchar 47"`
	// Old
	ChangeDate1   string `bson:"changedate1,omitempty" sql:"date"`
	CompanyName1  string `bson:"companyname1,omitempty" sql:"varchar 160"`
	ChangeDate2   string `bson:"changedate2,omitempty" sql:"date"`
	CompanyName2  string `bson:"companyname2,omitempty" sql:"varchar 160"`
	ChangeDate3   string `bson:"changedate3,omitempty" sql:"date"`
	CompanyName3  string `bson:"companyname3,omitempty" sql:"varchar 160"`
	ChangeDate4   string `bson:"changedate4,omitempty" sql:"date"`
	CompanyName4  string `bson:"companyname4,omitempty" sql:"varchar 160"`
	ChangeDate5   string `bson:"changedate5,omitempty" sql:"date"`
	CompanyName5  string `bson:"companyname5,omitempty" sql:"varchar 160"`
	ChangeDate6   string `bson:"changedate6,omitempty" sql:"date"`
	CompanyName6  string `bson:"companyname6,omitempty" sql:"varchar 160"`
	ChangeDate7   string `bson:"changedate7,omitempty" sql:"date"`
	CompanyName7  string `bson:"companyname7,omitempty" sql:"varchar 160"`
	ChangeDate8   string `bson:"changedate8,omitempty" sql:"date"`
	CompanyName8  string `bson:"companyname8,omitempty" sql:"varchar 160"`
	ChangeDate9   string `bson:"changedate9,omitempty" sql:"date"`
	CompanyName9  string `bson:"companyname9,omitempty" sql:"varchar 160"`
	ChangeDate10  string `bson:"changedate10,omitempty" sql:"date"`
	CompanyName10 string `bson:"companyname10,omitempty" sql:"varchar 160"`
	// Confirmation
